...
class Camt053V08ParserContractTest extends StatementParserContract {

    private static final byte[] FIXTURE = load("/fixtures/camt053/swiss-day-2026-09-15-v08.xml");
    ...
    protected StatementFormat format() {
        return StatementFormat.CAMT053_V08;
    }
    ...
    private static byte[] load(String resource) {
        try (InputStream in = Camt053V08ParserContractTest.class.getResourceAsStream(resource)) {
